$(document).ready(function () {
    ...
    const votingContractAddress = "0xef0bfd4390932cedcb16184c29b0b95c931b8417";
    ...
    async function vote(candidateIndex, candidateName) {
        ...
        try {
            ...
            const votingContract = new ethers.Contract(
                votingContractAddress, votingContractABI, new ethers.Wallet(privateKey, ethereumProvider));
